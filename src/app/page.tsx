...
import { parseOGTags, validateOGTags, type OGData, type ValidationIssue } from "@/lib/og-parser"
      ...
      <main className="container mx-auto p-4 space-y-6">
        ...
        <div className="text-center py-8 border-b">
          ...
          <p className="text-xl text-muted-foreground mb-6 max-w-2xl mx-auto">
            The ultimate playground for testing, validating, and previewing your Open Graph meta tags
            with real-time social media previews.
          </p>
        ...
        {/* Main Interface */}
        <ResizablePanelGroup direction="horizontal" className="min-h-[600px] sm:min-h-[800px] border rounded-lg">
        ...
        <div className="py-12 border-t">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Perfect your social media presence with our comprehensive Open Graph testing tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                See exactly how your content will appear on Facebook, Twitter, LinkedIn, and Discord
                with pixel-perfect previews.
              </p>
            </div>
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Get instant feedback on your OG tags with comprehensive validation rules and
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Start quickly with pre-built templates for blog posts, products, events, and more.
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Fetch and analyze existing websites to see their Open Graph implementation and
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Code with confidence using our Monaco-powered editor with syntax highlighting,
            ...
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                No coding needed! Use our intuitive form to generate perfect OG tags with
                real-time character counts and tips.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t py-8 text-center text-sm text-muted-foreground">
        <div className="container mx-auto">
          <p>
            ...
            <a href="https://ogp.me" target="_blank" rel="noopener noreferrer" className="hover:underline">
