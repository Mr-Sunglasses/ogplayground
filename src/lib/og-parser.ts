...
export function validateOGTags(ogData: OGData): ValidationIssue[] {
  ...
  if (!ogData.title) {
    ...
    if (ogData.title.length > 60) {
      ...
      issues.push({
        ...
        suggestion: "Consider expanding your title to be more descriptive while staying under 60 characters"
      })
    }
  }
  ...
  if (!ogData.description) {
    issues.push({
      ...
      suggestion: "Add <meta property=\"og:description\" content=\"Your page description\" />"
    })
  } else {
    ...
    if (ogData.description.length > 200) {
      ...
      issues.push({
        ...
        suggestion: "Consider expanding your description to be more informative while staying under 200 characters"
      })
    }
  }
...
<meta property="og:image:height" content="630" />`
  ...
  if (!ogData.type) {
    issues.push({
      ...
      suggestion: "Add <meta property=\"og:type\" content=\"website\" /> (or article, product, etc.)"
    })
  }
  
  // Twitter Cards validation
  if (ogData.twitterCard && !["summary", "summary_large_image", "app", "player"].includes(ogData.twitterCard)) {
    issues.push({
      type: "warning",
  ...
  if (ogData.type === "article") {
    if (!ogData.articleAuthor) {
      issues.push({
        ...
        suggestion: "Add <meta property=\"article:author\" content=\"Author Name\" />"
      })
    }
    ...
    if (!ogData.articlePublishedTime) {
      issues.push({
        ...
        suggestion: "Add <meta property=\"article:published_time\" content=\"2024-01-01T00:00:00Z\" />"
      })
    }
  }
...
export function generateOGTags(data: Partial<OGData>): string {
  ...
  if (data.twitterTitle) {
    tags.push(`<meta name="twitter:title" content="${escapeHtml(data.twitterTitle)}" />`)
  }
  
  if (data.twitterDescription) {
    tags.push(`<meta name="twitter:description" content="${escapeHtml(data.twitterDescription)}" />`)
  }
